    ...
    <section class="hero hero-page">
      ...
      <div class="container hero-inner">
        <div class="hero-copy">
          ...
          <ul class="hero-creds">
            <li><strong>Family-Owned</strong> &amp; Operated</li>
    ...
    <section class="section faq" id="faq">
      <div class="container faq-grid">
        ...
        <figure class="faq-media">
          ...
          <figcaption><strong>Free estimates first.</strong> Understand the work and the cost before you consider financing.</figcaption>
        </figure>
      </div>
    </section>
